...
public class NewsTestContainer extends TestContainer {

    public NewsTestContainer() {
        super();
    ...
    public static class Common extends NewsTestContainer {

        public static final NewsTestContainer.Common INSTANCE = new NewsTestContainer.Common();
